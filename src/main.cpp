...
int main()
{
    ...
    ,LoadTexture("assets/Earth.png")
    ,LoadTexture("assets/Mars.png")
    ,LoadTexture("assets/Jupiter.png")
    ,LoadTexture("assets/Saturn.png")
    ,LoadTexture("assets/Uranus.png")
    ,LoadTexture("assets/Neptune.png")
