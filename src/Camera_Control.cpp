...
void Camera_Control::Update_Info(float Delta_Time, Dynamic_array<CelestialBody*>& bodies, CelestialBody*& HoveredBody) {
...
void Camera_Control::Update(float Delta_Time)
{
...
bool Camera_Control::Is_Showing_Names() const
{
    return Show_Names;
}

Camera3D Camera_Control::Get_Camera() const
{
    return Cam;
}